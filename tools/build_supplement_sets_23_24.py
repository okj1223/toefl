...
QUANT_WORDS = [
    ...
    ("trendwise", "추세상", "세부 한 점보다 전체 방향 흐름을 기준으로", "낱값보다 큰 선의 방향을 따라 읽는 느낌", "trendwise=추세상 / locally=국지적으로 / overall=전반적으로"),
    ...
    ("databased", "자료 기반의", "주관보다 수집된 자료를 근거로 한", "느낌보다 데이터 바닥 위에 올려 말하는 느낌", "databased=자료 기반의 / empirical=실증적 / subjective=주관적"),
